...
var QueryResult = (function () {
    require('jdb-util').extends(QueryResult, Array);
    ...
    function QueryResult(result, q) {
        query = q;
        !(typeof result === 'undefined') ? this._setResults(QueryResult.__super__.constructor.apply(this, result)) : void 0;
        !(typeof query === 'undefined') ? this._parseResults() : void 0;
    ...
    QueryResult.prototype._parseResults = function () {
        this.results = require('jdb-util').merge({
            '#queryString': this.queryString(),
            '#elapsedtime': query.bench().elapsed_time('jsondb_(query)_start', 'jsondb_(query)_end'),
            '#memoryusage': query.bench().memory_usage('jsondb_(query)_start', 'jsondb_(query)_end')
        }, this.results);
    };
