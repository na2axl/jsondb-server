...
var Database = (function () {
    ...
    function Database(server, username, password, database) {
        ...
        this.config = require('jdb-configuration');
        this.benchmark = require('jdb-benchmark');
        ...
        if (config[server].username !== username || config[server].password !== password) {
            this.benchmark.mark('Database_(connect)_end');
        ...
        this.server = _p.normalize(_p.dirname(__dirname) + '/jdb-jsondb/servers/' + server);
    ...
    Database.prototype.tableExists = function (name) {
        ...
        return require('jdb-util').existsSync(this.server + "/" + this.database + "/" + name + ".json");
    };
    ...
    Database.prototype.query = function (query) {
        return (require('jdb-query')(query, this))._query();
    };
    ...
    Database.prototype.async.query = function (query, callback) {
        ...
        setImmediate(function () {
            (require('jdb-query')(query, instance)).async._query(callback);
        }.bind(this));
    };
    ...
    Database.prototype.prepare = function (query) {
        return (require('jdb-query')(query, this))._prepare();
    };
    ...
    Database.prototype.async.prepare = function (query, callback) {
        ...
        setImmediate(function () {
            var q = require('jdb-query')(query, instance);
